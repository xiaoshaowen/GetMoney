...
define('CACHE_EXT','mLpgg');

//勿忘－网站上线后，需要修改下面 3项
define('OPEN_DEBUG',1);//开启调试模式？2 服务器上开发调试 ；1 本地开发调试，遇到错误终止；0 关闭-网站上线后，需要关闭该项
...
define('WEBURL','http://localhost/');//网站域名

//Cookie配置
define('COOKIE_DOMAIN','');//Cookie 作用域
define('COOKIE_PATH','/');//Cookie 作用路径
define('COOKIE_PRE','NRw_'); //Cookie 前缀
define('COOKIE_TTL',0); //Cookie 生命周期，0 表示随浏览器进程

//附件相关配置
define('ATTACHMENT_ROOT',WWW_ROOT.'uploadfile/');
define('ATTACHMENT_URL','http://localhost/uploadfile/');//附件路径
define('R','http://localhost/res/');//静态文件存储目录
define('_KEY','UF6iMQdI'); //密钥,最长8位
